// From https://github.com/PretendoNetwork/account/blob/6421593505d1d20dfe76f7dd3c7247113f194993/src/nintendo-certificate.js
// Credits to the Pretendo Network team/affilated for the vast majority of this file
...
const WIIU_DEVICE_PUB_PEM =
`-----BEGIN PUBLIC KEY-----
MFIwEAYHKoZIzj0CAQYFK4EEABsDPgAEAP1WBBgs8XUJIQDDCK5IOZEbb5+h1TqV
rwgzSUcrAAFxMWm1kf/TDL9z2nZkuo0N+VtNEQREZDXA7aQv
-----END PUBLIC KEY-----`;

const CTR_DEVICE_PUB_PEM =
`-----BEGIN PUBLIC KEY-----
MFIwEAYHKoZIzj0CAQYFK4EEABsDPgAEAE47t01dlZ5ozpAENP6eSj8JSjN3H6fA
5LAjJk2YAUyh/HmdP6UhcdX5vVsXd+wP73o40Wabv4MDJYQ6
-----END PUBLIC KEY-----`;

const CTR_LFCS_B_PUB_PEM =
`-----BEGIN PUBLIC KEY-----
`
...
class NintendoCertificate {
	constructor(certificate) {
		...
		if (certificate) {
			if (certificate instanceof Buffer) {
				...
				this._certificate = Buffer.from(certificate, 'base64'); // if certificate isn't a byte buffer, assume it's base64 and convert it to one
			}
	...
	_parseCertificateData() {
		if (this._certificate.length === 0x110) {
			...
			// Assume regular certificate (Wii U/3DS Device Certificate)
	...
	_verifySignatureECDSA() {
		...
		console.log("type cert "+(pem == WIIU_DEVICE_PUB_PEM ? 'wii u' : '3ds'));
